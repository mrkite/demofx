            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(fx.ctx == null)) return [3 /*break*/, 2];
                        ...
                        fx.ctx = ctx;
                        return [4 /*yield*/, fx.effect.init(canvas.width, canvas.height)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
...
function toggle(name, el) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, demoFX.toggle(name, el)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
